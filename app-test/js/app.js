...
async function markProduct(productId) {
  try {
    ...
    // You may need to send a request to the server to update the product's "marked" status
    // Example: await fetch('mark_product.php', { method: 'POST', body: JSON.stringify({ productId }) });
